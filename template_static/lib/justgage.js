...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // color of label showing current value
    valueFontFamily: kvLookup('valueFontFamily', config, dataset, "Calibri"),
  ...
  if (obj.config.pointer) {
    ...
    obj.needle = obj.canvas.path().attr({
      ...
      "fill": (obj.config.pointerOptions.color !== null && obj.config.pointerOptions.color !== undefined) ? obj.config.pointerOptions.color : "#ffffff",
      ndl: [
        obj.config.min,
        obj.config.min,
        obj.config.max,
